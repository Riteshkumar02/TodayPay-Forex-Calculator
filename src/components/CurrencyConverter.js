...
const CurrencyConverter = () => {
  ...
  useEffect(() => {
    ...
    if (sourceValue && sourceCurrency !== targetCurrency) {
      ...
      setTargetValue(sourceValue); // If same currencies selected, set target value same as source value
    }
  ...
  return (
    <div className='cnt'>
      ...
      />
      <select name="sourceCurrency" value={sourceCurrency} onChange={handleChange}>
      ...
      <select name="targetCurrency" value={targetCurrency} onChange={handleChange}>
        <option value="INR">INR</option>
        <option value="USD">USD</option>
        <option value="AED">AED</option>
        <option value="GBP">GBP</option>
      ...
      <p>{targetValue} {targetCurrency}</p>
    </div>
  );
};
